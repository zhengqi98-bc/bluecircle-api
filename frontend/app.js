...
function goTo(page, turtleId){
  ...
  if(page==='profile'){
    ...
    if(av && !profileTurtleParam) av.src = TURTLES[0].photo || '';
...
let TURTLES = [
  ...
  {id:'BC-HN-2418',name:'Wenchang',nameEn:'Wenchang',sp:'Green Turtle',spEn:'Green',lat:19.85,lng:111.20,bat:77,spd:2.1,dep:18,risk:'low',color:'#1CA7A8',origin:'East Hainan Coast',originEn:'East Hainan',cclen:62,sex:'M',age:'Adult',photo:'/img/turtles/bc-hn-2418.jpg'},
  ...
  // Leatherbacks — Critically Endangered in West Pacific. Con Dao, VN nesting; deep divers
  {id:'BC-CD-2304',name:'Côn Đảo',nameEn:'Côn Đảo',sp:'Leatherback',spEn:'Leatherback',lat:8.71,lng:106.61,bat:62,spd:3.4,dep:286,risk:'high',color:'#FF7F50',origin:'Con Dao, Vietnam',originEn:'Côn Đảo, VN',cclen:148,sex:'F',age:'Adult',photo:'/img/turtles/bc-cd-2304.jpg'},
  {id:'BC-PG-2307',name:'Papua',nameEn:'Papua',sp:'Leatherback',spEn:'Leatherback',lat:-2.45,lng:135.42,bat:58,spd:3.1,dep:412,risk:'high',color:'#FF7F50',origin:'Papua',originEn:'Papua',cclen:155,sex:'F',age:'Adult',photo:'/img/turtles/bc-pg-2307.png'},
...
let TRACKS = {
  ...
  // Long-distance leatherback Con Dao → SCS pattern
...
const RSCI_DATA = [
  ...
  {id:11, name:'🏝 Con Dao Nesting Beach Survey', sub:'Con Dao Nesting Beach Long-Term Monitoring', sp:'Leatherback', region:'Con Dao, Vietnam', period:'2018—2024', data:'7 yr·1.8M points', fmts:['CSV','GeoJSON'], cat:'track'},
...
// ── ACTIVITY FEED ──
let EVENTS = [
  {av:'<img src="data:image/svg+xml;base64,"  style="width:32px;height:32px;border-radius:50%;object-fit:cover"  alt="Luna"/>',name:'Luna · BC-XS-2401',sp:'Green Turtle',sub:'Xisha North Is. seagrass foraging · 14.6 km today',time:'2 min ago',tag:'Online',tc:'p-green'},
  {av:'⚠️',name:'Selingan · BC-SB-2315 — Alert',sp:'Green Turtle',sub:'Borneo Turtle Islands · Battery 43% · 6 hrs no full upload',time:'14 min ago',tag:'Critical',tc:'p-red'},
  ...
  {av:'<img src="data:image/svg+xml;base64,"  style="width:32px;height:32px;border-radius:50%;object-fit:cover"  alt="Wenchang"/>',name:'Wenchang · BC-HN-2418',sp:'Green Turtle',sub:'E. Hainan coastal 19.8°N · Signal restored',time:'1 hr ago',tag:'Online',tc:'p-green'},
  ...
  {av:'<img src="data:image/svg+xml;base64,"  style="width:32px;height:32px;border-radius:50%;object-fit:cover"  alt="Pearl"/>',name:'Pearl · BC-XS-2421',sp:'Green Turtle',sub:'Xisha North Is. nesting area foraging · Night dive 22 m',time:'4 hr ago',tag:'Online',tc:'p-green'},
...
window.addEventListener('load',()=>{
  ...
  apiInit("/api/v1"); initApiData().then(function(){
    buildFeed();
    buildAllSparks();
    buildProfileBars();
    buildTrendBars();
